...
// 10 кадров анимации «бегущей полоски» вокруг цифры
const uint8_t SEG_SWIPE[10] = {
  SEG_A | SEG_F,           // верх слева
  SEG_A | SEG_B,           // верх справа
  SEG_B | SEG_C,           // правая вертикаль
  SEG_C | SEG_D,           // низ справа
  SEG_D | SEG_E,           // низ слева
  SEG_E | SEG_F,           // левая вертикаль
  SEG_F | SEG_G,           // слева + центр
  SEG_G,                   // центр
  SEG_G | SEG_D,           // центр + низ
  SEG_A | SEG_D | SEG_G    // вспышка: все горизонтали
};
